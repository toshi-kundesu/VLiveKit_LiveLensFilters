...
{
    [Serializable, VolumeComponentMenu("Post-processing/Kino/MyPostFx")]
    public sealed class MyPostFx : CustomPostProcessVolumeComponent, IPostProcessComponent
    {
        ...
        Dictionary<int, MyPyramid> _pyramids;

        MyPyramid GetPyramid(HDCamera camera)
        {
            MyPyramid candid;
            ...
            else
            {
                ...
                _pyramids[cameraID] = candid = new MyPyramid(camera);
            }
        ...
        {
            _material = CoreUtils.CreateEngineMaterial("Hidden/Kino/PostProcess/MyPostFx");
            _prop = new MaterialPropertyBlock();
            _pyramids = new Dictionary<int, MyPyramid>();
        }
        ...
        public override void Render(CommandBuffer cmd, HDCamera camera, RTHandle srcRT, RTHandle destRT)
        {
            ...
            HDUtils.DrawFullScreen(cmd, _material, pyramid[1].down, _prop, 5);

            _prop.SetTexture(ShaderIDs.InputTexture, pyramid[1].down);
    ...
    sealed class MyPyramid
    {
        ...
        public MyPyramid(HDCamera camera)
        {
            Allocate(camera);
        }
